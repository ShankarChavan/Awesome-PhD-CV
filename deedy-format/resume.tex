...
Real-time 3D registration for multi-session SLAM (\textit{ICRA'25})
\item \href{https://github.com/MIT-SPARK/VGGT-SLAM}{\textbf{VGGT-SLAM}} \githubstars{882} \\
Dense RGB SLAM with consistent reconstruction (\textit{NeurIPS'25})
\item \href{https://github.com/url-kaist/patchwork-plusplus}{\textbf{Patchwork++}} \githubstars{842} \\
Real-time ground segmentation for AV/robotics (\textit{IROS'22})
\item \href{https://github.com/LimHyungTae/ERASOR}{\textbf{ERASOR}} \githubstars{494} \\
Dynamic object removal for static map building (\textit{RA-L'21})
\end{tightemize}
\sectionsep
...
\item Grew combined GitHub adoption to 4K+ stars by maintaining 4 open-source robotics repos (\githubstars{2.1K}--\githubstars{643}).
\end{tightemize}
\sectionsep
...
\vspace{0.3cm}
\begin{tightemize}
% NOTE(hlim): Example entry for an AV/SLAM-focused application.
...
% NOTE(hlim): Example entry for a perception-focused application.
...
% NOTE(hlim): Example entry for a mapping / HD map application.
