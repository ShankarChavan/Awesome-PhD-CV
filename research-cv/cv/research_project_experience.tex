...
%---------------------------------------------------------
  ...
  \cventry
    ...
    {Development of Harmonic-Space Operation Using Seamless Information Sharing Among Large-Scale Heterogeneous UVs}
    {\spark} % Location
  ...
  % KETI-NRF Harmonic space
  \cventry
    {Supported by National Research Foundation, Republic of Korea} 
    {Research on Certifiable Perception and Long-Term Metric-Semantic Mapping for Autonomous Vehicles} 
